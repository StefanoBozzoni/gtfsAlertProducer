...
public class UnzipFiles {
	...
	public static void unzip(String sourceZipFile, String destFolder) throws IOException {
        ...
        if (!AppUtils.isValidFilePath(destFolder)) {
        	throw new IOException(MethodHandles.lookup().lookupClass().getEnclosingMethod().toString()+"  errore : Dest dir :"+destFolder+" is not a directory trying to unzip "+sourceZipFile );
        }
